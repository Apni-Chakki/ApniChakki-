<?php
// check_eod_status.php - puray dino k pending orders check kar rahe han hum yahan
...
try {
    ...
    // puray dino k pending ya processing orders dhoond rahe han
    ...
    // aaj k scheduled orders ka count nikal rahe han
    ...
    // kal k orders dhoond rahe han jin ko aaj pull kar saktay han
    ...
    // dukan ki capacity check kar rahe han yahan
    $opening = '09:00';
    $closing = '20:00';

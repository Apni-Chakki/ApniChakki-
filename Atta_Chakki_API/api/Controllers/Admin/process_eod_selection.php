<?php
// process_eod_selection.php - admin jo orders select karega unko complete kar rahe han
// baqi sab ko priority de kar aaj k top par rakh rahe han hum yahan
...
try {
    ...
    // Step 1: Puray dino k leftover orders dhoond rahe han
    ...
    // Step 2: Jin ko admin ne kaha hai, unko 'completed' kar rahe han
    ...
    // Step 3: Baqi pending orders ko aaj k queue k top par daal rahe han

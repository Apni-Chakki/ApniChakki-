...
$mapping = [
    ...
    'add_category.php' => 'controllers/products/add_category.php',
    'delete_category.php' => 'controllers/products/delete_category.php',
    'update_category.php' => 'controllers/products/update_category.php',

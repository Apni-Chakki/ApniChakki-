  ...
  const renderTimeline = (currentStatus) => {
    ...
    return (
      <div className="relative pt-8 pb-4">
        ...
        <div 
          className="absolute top-12 left-0 h-1 bg-primary -z-10 rounded-full transition-all duration-500"
    ...
    <div className="min-h-screen bg-slate-50 py-8 px-4 sm:px-6">
      <div className="container mx-auto max-w-4xl">
        <div className="text-center mb-10">
          <h1 className="text-4xl sm:text-5xl font-extrabold bg-gradient-to-r from-primary to-primary bg-clip-text text-transparent mb-4 tracking-tight">
            {t('Track Your Order')}
          </h1>
        ...
        <Card className="p-3 mb-10 shadow-lg border-primary/20 rounded-2xl bg-white/60 backdrop-blur-sm max-w-2xl mx-auto">
          <div className="flex md:flex-row flex-col gap-4">
            <div className="relative flex-1">
              ...
              <Input
                ...
                className="h-14 border-0 focus-visible:ring-0 bg-transparent text-lg md:text-xl font-medium placeholder:text-gray-400"
              />
            </div>
            <Button 
              onClick={handleSearch} 
              disabled={loading || !orderId.trim()}
              className="h-14 px-8 bg-primary hover:bg-primary/90 text-primary-foreground font-bold rounded-xl transition-all shadow-md md:w-auto w-full text-lg"
            >
                            ...
                            <div className="pt-4 border-t border-dashed border-gray-200">
                              <div className="flex justify-between items-center mb-3">
                                ...
                                <span className="font-semibold capitalize text-slate-800">
                                  ...
                                  {order.paymentStatus === 'paid' && <span className="ml-2 text-xs bg-primary/10 text-primary/90 px-2 py-1 rounded-md">PAID</span>}
                                </span>
                              </div>
                              <div className="flex justify-between items-center text-lg">
                                <span className="font-bold text-slate-800">{t('Total Amount')}</span>
                                <span className="font-extrabold text-primary">Rs. {order.total?.toLocaleString('en-PK')}</span>
                              </div>
                            </div>
                          </div>
                        </div>
